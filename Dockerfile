...
RUN echo y | android update sdk --filter platform-tools,build-tools-$buildTools,android-23,extra-google-m2repository,extra-android-m2repository --no-ui --force
